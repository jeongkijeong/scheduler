...
public class JobCheckItemWatch implements CustomJob {
	private Logger logger = LoggerFactory.getLogger(getClass());
	
	private String jobName = CHECK_ITEM;
	private String jobCron = "5 * * * * ?";

	public JobCheckItemWatch() {
		super();
		
		String cron = Utils.getProperty(Constant.CRON_CHECK_ITEM);
		if (cron != null) {
			this.jobCron = cron;
		}
	}
